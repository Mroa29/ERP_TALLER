...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    const idPresupuesto = document.getElementById("idPresupuestoManoObra");
    const rutClientePresupuesto = document.getElementById("rutClientePresupuestoManoObra");
    const placaVehiculoPresupuesto = document.getElementById("placaVehiculoPresupuestoManoObra");
    const sucursalPresupuesto = document.getElementById("sucursalPresupuestoManoObra");
    const diasValidezPresupuesto = document.getElementById("diasValidezPresupuestoManoObra");
