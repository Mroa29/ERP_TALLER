...
document.addEventListener("DOMContentLoaded", async function () {
    const inputBuscarPresupuesto = document.getElementById("buscarPresupuestoRepuestos");
    const listaCoincidenciasPresupuestos = document.getElementById("listaCoincidenciasPresupuestosRepuestos");

    // Elementos para la cabecera del modal
    const idPresupuesto = document.getElementById("idPresupuestoRepuestos");
    const rutClientePresupuesto = document.getElementById("rutClientePresupuestoRepuestos");
    const placaVehiculoPresupuesto = document.getElementById("placaVehiculoPresupuestoRepuestos");
    const sucursalPresupuesto = document.getElementById("sucursalPresupuestoRepuestos");
    const diasValidezPresupuesto = document.getElementById("diasValidezPresupuestoRepuestos");
