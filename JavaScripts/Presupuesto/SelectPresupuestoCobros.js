document.addEventListener("DOMContentLoaded", async function () {
    const inputBuscarPresupuesto = document.getElementById("buscarPresupuestoCobros");
    const listaCoincidenciasPresupuestos = document.getElementById("listaCoincidenciasPresupuestosCobros");

    // Elementos para la cabecera del modal
    const idPresupuesto = document.getElementById("idPresupuestoCobros");
    const rutClientePresupuesto = document.getElementById("rutClientePresupuestoCobros");
    const placaVehiculoPresupuesto = document.getElementById("placaVehiculoPresupuestoCobros");
    const sucursalPresupuesto = document.getElementById("sucursalPresupuestoCobros");
    const diasValidezPresupuesto = document.getElementById("diasValidezPresupuestoCobros");
